...
# export some exemplary spectra for NISTMS
peak_spectra_all %>%
  #filter(file == "/Users/jwinnikoff/Documents/MBARI/Lipids/GCMSData/cdf/20200212/Supel37_1-40_1_blanked.mzxml") %>%
  filter(file == "/Users/jwinnikoff/Documents/MBARI/Lipids/GCMSData/cdf/20200608/Supel37_1-32_1_blanked.mzxml") %>%
  ungroup() %>%
  mutate(scan = scan %>% as.factor() %>% as.integer()) %>%
  select(mz, intensity, scan, rt) %>%
  write_tidymass("/Users/jwinnikoff/Documents/MBARI/Lipids/cteno-lipids-2020/20200914_Supel37_scans/20200608_all_ROIs.mzxml")
